...
const translations = {
    es: {
        ...
        about: {
            title: "Sobre Mí",
            paragraphs: [
                "Soy un profesional especializado en Ciberseguridad en entornos IT, con formación en Administración de Sistemas Informáticos en Red (ASIR) y una especialización completada en Ciberseguridad. Mi experiencia profesional incluye haber trabajado como técnico de soporte en À Punt Mèdia, donde desarrollé competencias clave en la gestión y resolución de incidencias tecnológicas",
